...
<body>
    <div id="whole">
        <form action="${createLink(controller: 'book_register', action: 'modifyRegister2')}" method="post">
            <h2>Modify Register</h2>
            ...
            <input type="text" id="registerId" name="registerId" placeholder="Register ID" required>
